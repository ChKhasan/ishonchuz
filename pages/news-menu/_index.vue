        ...
        <div class="col-lg-9 col-md-12 p-0 home-page-left">
          ...
          <div class="messangers-container">
            <div class="messangers-banner">
              ...
              >
                <path
                  d="M28.5 0C12.756 0 0 12.3085 0 27.5C0 42.6915 12.756 55 28.5 55C44.244 55 57 42.6915 57 27.5C57 12.3085 44.244 0 28.5 0ZM42.4972 18.8397L37.82 40.1079C37.4752 41.6159 36.5444 41.9819 35.2458 41.2722L28.1208 36.2046L24.6847 39.3982C24.3054 39.7641 23.9837 40.0746 23.2482 40.0746L23.7538 33.0776L36.9581 21.5675C37.5327 21.0796 36.8316 20.8024 36.0732 21.2903L19.7546 31.2036L12.7216 29.0857C11.1931 28.62 11.1587 27.6109 13.0433 26.9012L40.5206 16.6774C41.7962 16.2339 42.9109 16.9768 42.4972 18.8397Z"
                  fill="#F9F9F9"
                />
              </svg>
                ...
                ><span>
                  ...
                  >
                    <g clip-path="url(#clip0_1988_6125)">
                      <path
                        d="M33.8177 32.6953H39.5841L41.8906 23.0078H33.8177V18.1641C33.8177 15.6695 33.8177 13.3203 38.4308 13.3203H41.8906V5.18281C41.1387 5.07867 38.2993 4.84375 35.3008 4.84375C29.0385 4.84375 24.5915 8.8568 24.5915 16.2266V23.0078H17.6719V32.6953H24.5915V53.2812H33.8177V32.6953Z"
                        fill="#0192FF"
                      />
                    </g>
                    <defs>
  ...
  head() {
    return {
      ...
      meta: [
        {
          name: "title",
          content: `${this.categories["title"]}`,
        },
        {
          name: "keywords",
          content: this.categories["desc"],
        },
        {
          name: "description",
          content: this.categories["desc"],
        },
        { hid: "og-title", property: "og:title", content: this.categories["title"] },
