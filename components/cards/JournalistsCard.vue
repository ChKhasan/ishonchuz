  ...
  <div class="journalists-card">
    ...
    <div class="journalist-card-info">
      <p>
        ...
        ></span>
        Ish joyi: <span>O’zbekiston Teleradio kompaniyasi</span>
      </p>
      <p><span v-html="target"></span>Tajribasi: <span>2 yil</span></p>
    </div>
  </div>
</template>
<script>
export default {
  data() {
    return {
      ...
      target: require("../../assets/svg/target.svg?raw"),
    };
  },
};
</script>
...
.journalist-card-title a span svg {
  transform: rotate(-90deg);
  height: 24px;
  width: 13px;
  margin-left: 6px;
}
.journalist-card-title a span {
  display: flex;
  align-items: center;
}
.journalist-card-title a span svg path {
  fill: #34a8ff;
}
